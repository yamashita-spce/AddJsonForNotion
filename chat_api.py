...
OPENAI_API_KEY = config["DEFAULT"]["GPTAPI_TOKEN"]
MODEL = "gpt-4o"

def openAPI(json_data) -> str:

    client = OpenAI(api_key=OPENAI_API_KEY)

    content = """ 
    jsonデータから業種、部署、役職、担当の情報を必ずJSON形式のみで返してください。ただし、業種、部署、役職、担当は以下のリストから最も近しいものを一つ選択してください。
